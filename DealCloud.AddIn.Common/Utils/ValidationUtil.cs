...
namespace DealCloud.AddIn.Common.Utils
{
    ...
    {
        public static void ClearValidationErrors(Control.ControlCollection controls, ErrorProvider errorProvider)
        {
            foreach (Control control in controls)
            {
                ...
                {
                    ClearValidationErrors(control.Controls, errorProvider);
                }
            }
        }
